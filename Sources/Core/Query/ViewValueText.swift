...
/// spellings of a date is what makes a person doubt the one they are reading. In `Core` rather
/// than beside the renderers for the same reason `ViewField.label` is: `perg view run` prints
/// cells too, and a view has to answer a shell and a window with the same words (ADR-0009 §D4).
enum ViewValueText {
