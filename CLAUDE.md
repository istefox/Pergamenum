...
scripts/check-merge-integrity.py --self-test                                                    # ADR-0061's own assertions, offline, touches no repository
scripts/install-git-hooks.sh                                                                    # once per machine: installs the pre-push guard from ADR-0061
```
