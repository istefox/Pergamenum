<!-- step5-brief: digest project-md=/Users/stefer/Developer/Pergamenum/PROJECT.md -->
# Project Roadmap digest -- PROJECT.md

Phase headings and checkbox lines only (VCS-057/ADR-0185, L1 roadmap digest) -- the
narrative prose between them is not included. Use this only to recognise existing
interfaces, naming and patterns already `[x]` done; never as a substitute for the plan
or SPEC governing this batch.
